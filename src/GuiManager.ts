...
export class GuiManager {
	...
	protected addMainGui(): void {
		...
		this.mainGui.add(this.mappings, 'instancingMethod', {LodMeshes: InstancingMethod.None, InstancedMesh: InstancingMethod.InstancedMesh, InstancedBufferGeometry: InstancingMethod.InstancedBufferGeometry}).name('Instancing method').onChange(async () => {
